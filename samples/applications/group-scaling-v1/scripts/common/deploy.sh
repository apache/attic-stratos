...
curl -X POST -H "Content-Type: application/json" -d "@${iaas_artifacts_path}/deployment_policy.json" -k -v -u admin:admin https://${host_ip}:${host_port}/api/applications/group-scaling-v1/deploy
