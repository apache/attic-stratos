...
//ajax call to the UI back end get the data to the charts 
            ...
            success: function (data) {
                ...
                if('error' != data.status){
                    ...
                    if('InFlight' == buttonName){
                       ...
                       uniqueChart('chart3',jsonDataFlightRequest,buttonName); 
                       ...
                       uniqueChart('chart2',jsonDataLoadAvg,buttonName); 
                       ...
                       uniqueChart('chart1',jsonDataMemoryAvg,buttonName); 
    ...
    function uniqueChart (chart,dataset,buttonName) {
    ...
    var containerEl = document.getElementById( elementId ),
        ...
        area = d3.svg.area()
                      ...
                      .y0( height )
                      .y1( function( d ) { return y( eval(drawchart) ); } ),

        line = d3.svg.line()
                  .interpolate( 'linear' )
                  .x( function( d ) { return x( d.timeStamp ) + detailWidth / 2; } )
                  .y( function( d ) { return y( eval(drawchart) ); } ),
    ...
    // hacky hacky hacky :(
    y.domain( [ 0, d3.max( data, function( d ) { return eval(drawchart); } ) + 100 ] );
...
//d1.getUTCFullYear(), d1.getUTCMonth(), d1.getUTCDate(), d1.getUTCHours(), d1.getUTCMinutes(), d1.getUTCSeconds()
